...
const SheetTriggerPrimitive = SheetPrimitive.Trigger;
...
/* -------------------------------------------------------------------------- */
/* Convenience trigger (ShadCN pattern)                                       */
/* -------------------------------------------------------------------------- */

const SheetTriggerComponent = ({
  children,
  onClick,
  className,
}: {
  ...
  <Button
    variant="outline"
    className={cn('sheet-trigger w-full py-3 mt-4', className)}
...
/* Public exports                                                             */
/* -------------------------------------------------------------------------- */
/* Aliases that shadcn-generated code (DataTable, etc.) expects               */
export const Sheet = SheetRoot;
export const SheetContent = SheetComponent;
export const SheetTrigger = SheetTriggerPrimitive;

/* Granular exports for advanced control                                      */
export {
  SheetRoot,
  SheetPortal,
  SheetOverlay,
